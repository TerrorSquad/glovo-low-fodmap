import { CardManager } from '@/entrypoints/content/CardManager'
import { DomProductScanner } from '@/entrypoints/content/DomProductScanner'
import {
  type IFodmapHelper,
  MessageHandler,
} from '@/entrypoints/content/MessageHandler'
import { ProductManager } from '@/entrypoints/content/ProductManager'
import { StorageManager } from '@/entrypoints/content/StorageManager'
